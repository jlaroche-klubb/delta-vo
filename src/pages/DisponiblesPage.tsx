...
export default function DisponiblesPage({ userRole, userName, userEmail }: DisponiblesPageProps) {
  ...
  function handleAnnulerOffre(machine: Machine) {
    if (window.confirm(t("dispo.confirmCancelOffer", { immat: machine.immat }))) {
  ...
  async function doGeneratePdf(machine: Machine, prixChoisi: "fr" | "dealer") {
    ...
    setTimeout(async () => {
      try {
        ...
        alert(t("dispo.errPdf") + err.message);
        console.error(err);
      } finally {
        setGenerating(false);
  ...
  async function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      alert(t("dispo.errImport") + err.message);
    } finally {
      setImporting(false);
  ...
  async function handleStockFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      alert(t("dispo.errImportStock") + err.message);
    } finally {
  ...
  async function handleRefreshExpertise() {
    ...
    try {
      ...
      alert(t("dispo.errExpertises") + err.message);
    } finally {
  ...
  async function handleRattrapage() {
    ...
    try {
      ...
      alert(t("dispo.errRattrapage") + err.message);
    } finally {
      setRattrapage(false);
    }
  }
